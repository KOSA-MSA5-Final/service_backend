...
public class DiseaseServiceDeleteTests {
    ...
    public void testDeleteDiseaseNames() {
        // 대분류 병명 삭제
        diseaseNamesService.deleteDiseaseById(savedDiseaseNames.getId());
    ...
    public void testDeleteDiseaseSub() {
        // 소분류 병명 삭제
        diseaseSubService.deleteDiseaseSubById(savedDiseaseSub.getId());
    ...
    public void testDeleteNewDisease() {
        // 새로운 병명 삭제
        newDiseaseService.deleteNewDiseaseById(savedNewDisease.getId());
